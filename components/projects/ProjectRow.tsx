...
export default function ProjectRow({ project, variant = "card" }: ProjectRowProps) {
  ...
  const containerClass = isList
    ...
    : "group block rounded-2xl border border-border/20 bg-card/30 px-5 py-4 transition-all duration-200 hover:bg-card/60 hover:border-border/40 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/25 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
